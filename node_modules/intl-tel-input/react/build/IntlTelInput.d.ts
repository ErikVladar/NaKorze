...
declare module "modules/core/ui" {
    ...
    export default class UI {
        ...
        private _maybeEnsureDropdownWidthSet;
        ...
        private getHiddenInlineDropdownHeight;
...
declare module "modules/core/numerals" {
    export class Numerals {
        ...
        constructor();
        private updateNumeralSet;
        denormalise(str: string, currentInputValue: string): string;
