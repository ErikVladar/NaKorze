    ...
    <div
        ...
        <section class="relative w-full overflow-hidden">
            ...
            <div class="hidden md:grid md:mt-20 md:grid-cols-1 gap-8 md:px-10 py-12">
                <!-- Dashboard Section -->
                <div id="coffee" class="relative z-30 rounded-2xl overflow-hidden group" role="button"
                    tabindex="0">
                    <div class="w-full h-[80vh] flex flex-col md:flex-row overflow-hidden relative">
                        ...
                        <div class="md:w-1/2 md:p-8 flex items-center justify-center">
                            <img src="bog/JPEG image-4C97-B2D8-52-14.jpeg" alt="Dashboard"
                                class="rounded-xl shadow-lg w-full h-full object-cover">
                        </div>
                    </div>
                </div>

                <div id="cukr" class="relative z-30 rounded-2xl overflow-hidden group" role="button"
                    tabindex="0">
                    <div class="w-full h-[80vh] flex flex-col md:flex-row overflow-hidden relative">
                ...
                <!-- Ice Section -->
                <div id="ice" class="relative z-30 rounded-2xl overflow-hidden group" role="button"
                    tabindex="0">
                    <div class="w-full h-[80vh] flex flex-col md:flex-row overflow-hidden relative">
                        <!-- Text Section -->
                        <div class="md:w-1/2 p-8 flex flex-col justify-center text-white">
                ...
                <!-- Bar Section -->
                <div id="bar_nav" class="relative z-30 rounded-2xl overflow-hidden group" role="button"
                    tabindex="0">
                    <div class="w-full h-[80vh] flex flex-col md:flex-row overflow-hidden relative">
                        <!-- Image Section -->
                        <div class="md:w-1/2 p-8 flex items-center justify-center">
