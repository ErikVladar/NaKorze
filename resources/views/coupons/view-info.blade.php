<x-app-layout>
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-800">{{ $coupon->valid_from->format('d.m.Y') }}
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">{{ __('dashboard.valid_until') }}</p>
                            <p class="text-sm font-semibold text-gray-800">{{ $coupon->valid_until->format('d.m.Y') }}
                            </p>
                        </div>
                    </div>
            ...
            <div class="space-y-3">
                <a href="/"
                    class="block w-full text-center py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-lg transition">
